...
module.exports = (player, profile) => {
  ...
  return {
    ...
    mithril_powder: {
      ...
      total:
        (mining_stats?.powder_mithril_total || 0) +
        (mining_stats?.powder_spent_mithril || 0),
    },
    gemstone_powder: {
      current: mining_stats?.powder_gemstone_total || 0,
      total:
        (mining_stats?.powder_gemstone_total || 0) +
        (mining_stats?.powder_spent_gemstone || 0),
    },
    hotM_tree: {
      tokens: {
      ...
      pickaxe_ability:
        perks[mining_stats?.selected_pickaxe_ability]?.name || null,
    },
    crystal_hollows: {
      ...
      crystals: [
        {
          ...
          state: titleCase(
            mining_stats?.crystals?.jade_crystal?.state || "Not Found",
            true
          ),
        },
        {
          name: "Amber Crystal",
          total_placed:
            mining_stats?.crystals?.amber_crystal?.total_placed || 0,
          king_quests_completed:
            mining_stats?.biomes?.goblin?.king_quests_completed || 0,
          state: titleCase(
            mining_stats?.crystals?.amber_crystal?.state || "Not Found",
            true
          ),
        },
        {
          ...
          total_placed:
            mining_stats?.crystals?.sapphire_crystal?.total_placed || 0,
          parts_delivered:
            mining_stats?.biomes?.precursor?.parts_delivered || [],
          state: titleCase(
            mining_stats?.crystals?.sapphire_crystal?.state || "Not Found",
            true
          ),
        },
        {
          ...
          total_placed:
            mining_stats?.crystals?.amethyst_crystal?.total_placed || 0,
          state: titleCase(
            mining_stats?.crystals?.amethyst_crystal?.state || "Not Found",
            true
          ),
        },
        {
          name: "Topaz Crystal",
          total_placed:
            mining_stats?.crystals?.topaz_crystal?.total_placed || 0,
          state: titleCase(
            mining_stats?.crystals?.topaz_crystal?.state || "Not Found",
            true
          ),
        },
        {
          name: "Jasper Crystal",
          total_placed:
            mining_stats?.crystals?.jasper_crystal?.total_placed || 0,
          state: titleCase(
            mining_stats?.crystals?.jasper_crystal?.state || "Not Found",
            true
          ),
        },
        {
          ...
          state: titleCase(
            mining_stats?.crystals?.ruby_crystal?.state || "Not Found",
            true
          ),
        },
      ],
