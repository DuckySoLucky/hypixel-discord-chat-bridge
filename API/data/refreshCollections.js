...
module.exports = async () => {
  async function refreshCollections() {
    ...
    const items_res = (
      await axios.get("https://api.hypixel.net/resources/skyblock/items")
    ).data.items;
    fs.writeFileSync("API/json/items.json", JSON.stringify(items_res, null, 2));
  }
