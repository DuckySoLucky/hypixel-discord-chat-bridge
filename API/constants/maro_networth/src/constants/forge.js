module.exports = {
    forge_recipes: {
      ...
      REFINED_MITHRIL: {
        ENCHANTED_MITHRIL: 160
      },
      REFINED_TITANIUM: {
        ENCHANTED_TITANIUM: 16
      },
      FUEL_TANK: {
        ENCHANTED_COAL_BLOCK: 2
      },
      BEJEWELED_HANDLE: {
        GLACITE_JEWEL: 3
      },
      ...
      GEMSTONE_DRILL_4: {
        GEMSTONE_DRILL_3: 1,
        FLAWLESS_JASPER_GEM: 1,
        TREASURITE: 100
      },
      SAPPHIRE_POLISHED_DRILL_ENGINE: {
        TITANIUM_DRILL_ENGINE: 1,
        ELECTRON_TRANSMITTER: 25,
        FTX_3070: 25,
        FINE_SAPPHIRE_GEM: 20
      },
      DIVAN_HELMET: {
        DIVAN_FRAGMENT: 5,
        GEMSTONE_MIXTURE: 10,
      ...
      AMBER_POLISHED_DRILL_ENGINE: {
        ...
        SAPPHIRE_POLISHED_DRILL_ENGINE: 1,
        FLAWLESS_AMBER_GEM: 1,
        ROBOTRON_REFLECTOR: 50
      },
      PERFECTLY_CUT_FUEL_TANK: {
        GEMSTONE_FUEL_TANK: 1,
        SYNTHETIC_HEART: 70,
        GEMSTONE_MIXTURE: 25
      },
      DIVAN_DRILL: {
