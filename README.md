...
|`fetchur` | Information about an item for Fetchur |  | !fetcher | [Responce Of Example](imgurLinkWhen)
...
|`help` | Shows help menu |  | !help | [Responce Of Example](imgurLinkWhen)
|`kitty` | Random image of cute cat |  | !kitty | [Responce Of Example](imgurLinkWhen)
...
|`render` | Renders item of specified user | [player] [slot] | !redner SpookyKath 1 | [Responce Of Example](imgurLinkWhen)
|`skills` | Skills and Skill Average of specified user | [player] | !skills | [Responce Of Example](imgurLinkWhen)
|`skywars` | Skywars stats of specified user | [player] | !skywars | [Responce Of Example](imgurLinkWhen)
|`skyblock` | Skyblock Stats of specified user | [player] | !skyblock | [Responce Of Example](imgurLinkWhen)
|`slayer` | Slayer of specified user | [player] [type] | !slayer | [Responce Of Example](imgurLinkWhen)
|`UHC` | UHC Stats of specified user | [player] | !uhc | [Responce Of Example](imgurLinkWhen)
|`weight` | Skyblock Stats of specified user | [player] | !weight | [Responce Of Example](imgurLinkWhen)
|`winstreak` | Estimated winstreaks of the specified user in bedwars | [player] | !winstreak | [Responce Of Example](imgurLinkWhen)
|`woolwars` | WoolWars stats of specified user | [player] | !woolwars | [Responce Of Example](imgurLinkWhen)
