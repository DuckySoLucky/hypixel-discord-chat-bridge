...
|--|--|--|--|--|
|`8ball` | Ask an 8ball a question | <question> | !8ball is DuckySoLuckyHot | [Responce Of Example](wwwwwww)
|`armor` | Renders armor of specified user | [player] | !Armour SpookyKath | [Responce Of Example](wwwwwww)
|`auction` | Active Auctions of specified user | [player] | !auction | [Responce Of Example](wwwwwww)
|`bedwars` | BedWars stats of specified user | [player] | !bedwars | [Responce Of Example](wwwwwww)
|`catacombs` | Skyblock Dungeons Stats of specified user | [player] | !dungeons | [Responce Of Example](wwwwwww)
|`accessories` | Accessories of specified user | [player] | !accessories | [Responce Of Example](wwwwwww)
|`denick` | Denick username of specified user | <player> | !denick Jediiii | [Responce Of Example](wwwwwww)
|`duels` | Duel stats of specified user | [player] | !duels | [Responce Of Example](wwwwwww)
|`equipment` | Renders equipment of specified user | [player] | !equipment | [Responce Of Example](wwwwwww)
|`fairysouls` | Fairy Souls of specified user | [player] | !fairysouls | [Responce Of Example](wwwwwww)
|`fetchur` | Information about an item for Fetchur |  | !fetcher | [Responce Of Example](wwwwwww)
|`guildexp` | Guilds experience of specified user | [player] | !guildexp | [Responce Of Example](wwwwwww)
|`guild` | Look up a guild based on its name | <guildName> | !guild Felony | [Responce Of Example](wwwwwww)
|`go` | Look up a guild based on a players ign | <player> | !go SpookyKath | [Responce Of Example](wwwwwww)
|`help` | Shows help menu |  | !help | [Responce Of Example](wwwwwww)
|`kitty` | Random image of cute cat |  | !kitty | [Responce Of Example](wwwwwww)
|`math` | Calculate any kind of math problem | <calculation> | !math 1+1 | [Responce Of Example](wwwwwww)
|`networth` | Networth of specified user | [player] | !networth | [Responce Of Example](wwwwwww)
|`pet` | Renders active pet of specified user | [player] | !pet | [Responce Of Example](wwwwwww)
|`render` | Renders item of specified user | [player] [slot] | !redner SpookyKath 1 | [Responce Of Example](wwwwwww)
|`skills` | Skills and Skill Average of specified user | [player] | !skills | [Responce Of Example](wwwwwww)
|`skywars` | Skywars stats of specified user | [player] | !skywars | [Responce Of Example](wwwwwww)
|`skyblock` | Skyblock Stats of specified user | [player] | !skyblock | [Responce Of Example](wwwwwww)
|`slayer` | Slayer of specified user | [player] [type] | !slayer | [Responce Of Example](wwwwwww)
|`UHC` | UHC Stats of specified user | [player] | !uhc | [Responce Of Example](wwwwwww)
|`weight` | Skyblock Stats of specified user | [player] | !weight | [Responce Of Example](wwwwwww)
|`winstreak` | Estimated winstreaks of the specified user in bedwars | [player] | !winstreak | [Responce Of Example](wwwwwww)
|`woolwars` | WoolWars stats of specified user | [player] | !woolwars | [Responce Of Example](wwwwwww)
