...
|`math` | Calculate any kind of math problem | `!math <calculation>` | !math 1+1 | [Responce Of Example](imgurLinkWhen)
|`networth` | Networth of specified user | `!networth [player]` | !networth | [Responce Of Example](imgurLinkWhen)
|`pet` | Renders active pet of specified user | `!pet [player]` | !pet | [Responce Of Example](imgurLinkWhen)
|`render` | Renders item of specified user | `!render [player] [slot]` | !redner SpookyKath 1 | [Responce Of Example](imgurLinkWhen)
|`skills` | Skills and Skill Average of specified user | `!skills [player]` | !skills | [Responce Of Example](imgurLinkWhen)
|`skywars` | Skywars stats of specified user | `!skywars [player]` | !skywars | [Responce Of Example](imgurLinkWhen)
|`skyblock` | Skyblock Stats of specified user | `!skyblock [player]` | !skyblock | [Responce Of Example](imgurLinkWhen)
|`slayer` | Slayer of specified user | `!slayer [player] [type]` | !slayer | [Responce Of Example](imgurLinkWhen)
|`UHC` | UHC Stats of specified user | `!uhc [player]` | !uhc | [Responce Of Example](imgurLinkWhen)
|`weight` | Skyblock Stats of specified user | `!weight [player]` | !weight | [Responce Of Example](imgurLinkWhen)
|`winstreak` | Estimated winstreaks of the specified user in bedwars | `!winstreak [player]` | !winstreak | [Responce Of Example](imgurLinkWhen)
|`woolwars` | WoolWars stats of specified user | `!woolwars [player]` | !woolwars | [Responce Of Example](imgurLinkWhen)
