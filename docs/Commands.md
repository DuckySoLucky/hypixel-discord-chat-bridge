...
| `inactivity`           | Send an inactivity notice to the guild staff           | `/inactivity (time) [reason]`             | GuildMember |
...
This document is [auto generated](/scripts/docs/Commands.ts) and was last updated on `Wed, 12 Aug 2026 05:47:49 GMT` (`1786513669216`)
