...
| `guild`              | View information of a guild                                                   | g                                                      | `!guild (name)`            | Anyone     |
| `guildexp`           | Guilds experience of specified user.                                          | gexp                                                   | `!guildexp [u]`            | Anyone     |
| `guildof`            | View the player's guild                                                       | gof, guildofplayer, gop                                | `!guildof (u)`             | Anyone     |
...
| `sheepwars`          | SheepWars stats of specified user.                                            | sheep                                                  | `!sheepwars [u]`           | Anyone     |
