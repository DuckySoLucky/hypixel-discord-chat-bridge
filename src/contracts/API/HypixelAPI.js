...
async function getKeyData() {
  ...
  try {
    return (
      await axios.get(
        `${config.api.hypixelAPI}/?key=${config.api.hypixelAPIkey}`
      )
    ).data;
  } catch (error) {
    return error;
...
async function getFriends(uuid) {
  ...
  return (
    await axios.get(
      `${config.api.hypixelAPI}/friends?key=${config.api.hypixelAPIkey}&uuid=${uuid}`
    )
  ).data;
}
async function getRecentGames(uuid) {
  ...
  try {
    ...
    return (
      await axios.get(
        `${config.api.hypixelAPI}/recentgames?key=${config.api.hypixelAPIkey}&uuid=${uuid}`
      )
    ).data;
  } catch (error) {
    return error;
...
async function getPlayerStatus(uuid) {
  ...
  try {
    ...
    return (
      await axios.get(
        `${config.api.hypixelAPI}/status?key=${config.api.hypixelAPIkey}&uuid=${uuid}`
      )
    ).data;
  } catch (error) {
    return error;
...
async function getGuildData(uuid) {
  ...
  try {
    if (uuid.length == 24) {
      return (
        await axios.get(
          `${config.api.hypixelAPI}/guild?key=${config.api.hypixelAPIkey}&id=${uuid}`
        )
      ).data;
    } else if (uuid.length.replaceAll("-", "") == 32) {
      return (
        await axios.get(
          `${config.api.hypixelAPI}/guild?key=${config.api.hypixelAPIkey}&player=${uuid}`
        )
      ).data;
    } else {
      return (
        await axios.get(
          `${config.api.hypixelAPI}/guild?key=${config.api.hypixelAPIkey}&name=${uuid}`
        )
      ).data;
    }
  } catch (error) {
...
async function getChallenges() {
  ...
  try {
    return (await axios.get(`${config.api.hypixelAPI}/resources/challenges`))
      .data;
  } catch (error) {
    return error;
  }
...
async function getSkyblockElections() {
  ...
  try {
    return (
      await axios.get(`${config.api.hypixelAPI}/resources/skyblock/election`)
    ).data;
  } catch (error) {
    return error;
  }
...
async function getSkyblockBingoData() {
  ...
  try {
    return (
      await axios.get(`${config.api.hypixelAPI}/resources/skyblock/bingo`)
    ).data;
  } catch (error) {
    return error;
  }
...
async function getLatestSkyblockNews() {
  ...
  try {
    return (
      await axios.get(
        `${config.api.hypixelAPI}/skyblock/news?key=${config.api.hypixelAPIkey}`
      )
    ).data;
  } catch (error) {
    return error;
...
async function getSkyblockCollections() {
  ...
  try {
    return (
      await axios.get(
        `${config.api.hypixelAPI}/resources/skyblock/collecctions`
      )
    ).data;
  } catch (error) {
    return error;
...
async function getSkyblockSkills() {
  ...
  try {
    return (
      await axios.get(`${config.api.hypixelAPI}/resources/skyblock/skills`)
    ).data;
  } catch (error) {
    return error;
  }
...
async function getSkyblockItems() {
  ...
  try {
    return (
      await axios.get(`${config.api.hypixelAPI}/resources/skyblock/items`)
    ).data;
  } catch (error) {
    return error;
  }
...
async function getBoosters() {
  ...
  try {
    return (
      await axios.get(
        `${config.api.hypixelAPI}/boosters?key=${config.api.hypixelAPIkey}`
      )
    ).data;
  } catch (error) {
    return error;
...
async function getPlayerCount() {
  ...
  try {
    return (
      await axios.get(
        `${config.api.hypixelAPI}/counts?key=${config.api.hypixelAPIkey}`
      )
    ).data;
  } catch (error) {
    return error;
...
async function getWatchDogData() {
  ...
  try {
    return (
      await axios.get(
        `${config.api.hypixelAPI}/punishmentstats?key=${config.api.hypixelAPIkey}`
      )
    ).data;
  } catch (error) {
    return error;
...
module.exports = {
  ...
  getGamesData,
  getChallenges,
  getLatestSkyblockNews,
  getSkyblockElections,
  getLeaderboards,
  getSkyblockBingoData,
