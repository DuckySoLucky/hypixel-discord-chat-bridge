...
class LinkedManager extends GenericManager<LinkedUserData, LinkedData, LinkedUser> {
  ...
  async getPlayerVariableStats(
    ...
    return {
      ...
      hypixelLevel: Math.floor(player.level.level),
      hypixelKarma: Math.floor(player.karma),
      hypixelAchievementPoints: Math.floor(player.achievements.points),
      ...
      bedwarsKillDeathRatio: Math.floor(player.stats.BedWars.kills.total.ratio),
      bedwarsFinalKills: Math.floor(player.stats.BedWars.finals.total.kills),
      bedwarsFinalDeaths: Math.floor(player.stats.BedWars.finals.total.deaths),
      bedwarsFinalKillDeathRatio: Math.floor(player.stats.BedWars.finals.total.ratio),
      bedwarsWins: Math.floor(player.stats.BedWars.wins),
      bedwarsLosses: Math.floor(player.stats.BedWars.losses),
      bedwarsWinLossRatio: Math.floor(player.stats.BedWars.winLossRatio),
      bedwarsBedsBroken: Math.floor(player.stats.BedWars.beds.broken),
      bedwarsBedsLost: Math.floor(player.stats.BedWars.beds.lost),
      bedwarsBedsBrokenLostRatio: Math.floor(player.stats.BedWars.beds.ratio),
      ...
      bedwarsSoloKillDeathRatio: Math.floor(player.stats.BedWars.eightOne.kills.total.ratio),
      bedwarsSoloFinalKills: Math.floor(player.stats.BedWars.eightOne.finals.total.kills),
      bedwarsSoloFinalDeaths: Math.floor(player.stats.BedWars.eightOne.finals.total.deaths),
      bedwarsSoloFinalKillDeathRatio: Math.floor(player.stats.BedWars.eightOne.finals.total.ratio),
      ...
      bedwarsSoloWinLossRatio: Math.floor(player.stats.BedWars.eightOne.winLossRatio),
      ...
      bedwarsSoloBedsBrokenLostRatio: Math.floor(player.stats.BedWars.eightOne.beds.ratio),
      ...
      bedwarsDoublesKillDeathRatio: Math.floor(player.stats.BedWars.eightTwo.kills.total.ratio),
      bedwarsDoublesFinalKills: Math.floor(player.stats.BedWars.eightTwo.finals.total.kills),
      bedwarsDoublesFinalDeaths: Math.floor(player.stats.BedWars.eightTwo.finals.total.deaths),
      bedwarsDoublesFinalKillDeathRatio: Math.floor(player.stats.BedWars.eightTwo.finals.total.ratio),
      ...
      bedwarsDoublesWinLossRatio: Math.floor(player.stats.BedWars.eightTwo.winLossRatio),
      ...
      bedwarsDoublesBedsBrokenLostRatio: Math.floor(player.stats.BedWars.eightTwo.beds.ratio),
      ...
      bedwarsThreesKillDeathRatio: Math.floor(player.stats.BedWars.fourThree.kills.total.ratio),
      bedwarsThreesFinalKills: Math.floor(player.stats.BedWars.fourThree.finals.total.kills),
      bedwarsThreesFinalDeaths: Math.floor(player.stats.BedWars.fourThree.finals.total.deaths),
      bedwarsThreesFinalKillDeathRatio: Math.floor(player.stats.BedWars.fourThree.finals.total.ratio),
      ...
      bedwarsThreesWinLossRatio: Math.floor(player.stats.BedWars.fourThree.winLossRatio),
      ...
      bedwarsThreesBedsBrokenLostRatio: Math.floor(player.stats.BedWars.fourThree.beds.ratio),
      ...
      bedwarsFoursKillDeathRatio: Math.floor(player.stats.BedWars.fourFour.kills.total.ratio),
      bedwarsFoursFinalKills: Math.floor(player.stats.BedWars.fourFour.finals.total.kills),
      bedwarsFoursFinalDeaths: Math.floor(player.stats.BedWars.fourFour.finals.total.deaths),
      bedwarsFoursFinalKillDeathRatio: Math.floor(player.stats.BedWars.fourFour.finals.total.ratio),
      ...
      bedwarsFoursWinLossRatio: Math.floor(player.stats.BedWars.fourFour.winLossRatio),
      ...
      bedwarsFoursBedsBrokenLostRatio: Math.floor(player.stats.BedWars.fourFour.beds.ratio),
      bedwarsFoursPlayedGames: Math.floor(player.stats.BedWars.fourFour.gamesPlayed),

      bedwarsTwoFourKills: Math.floor(player.stats.BedWars.twoFour.kills.total.kills),
      bedwarsTwoFourDeaths: Math.floor(player.stats.BedWars.twoFour.kills.total.deaths),
      bedwarsTwoFourKillDeathRatio: Math.floor(player.stats.BedWars.twoFour.kills.total.ratio),
      bedwarsTwoFourFinalKills: Math.floor(player.stats.BedWars.twoFour.finals.total.kills),
      bedwarsTwoFourFinalDeaths: Math.floor(player.stats.BedWars.twoFour.finals.total.deaths),
      bedwarsTwoFourFinalKillDeathRatio: Math.floor(player.stats.BedWars.twoFour.finals.total.ratio),
      bedwarsTwoFourWins: Math.floor(player.stats.BedWars.twoFour.wins),
      bedwarsTwoFourLosses: Math.floor(player.stats.BedWars.twoFour.losses),
      bedwarsTwoFourWinLossRatio: Math.floor(player.stats.BedWars.twoFour.winLossRatio),
      bedwarsTwoFourBedsBroken: Math.floor(player.stats.BedWars.twoFour.beds.broken),
      bedwarsTwoFourBedsLost: Math.floor(player.stats.BedWars.twoFour.beds.lost),
      bedwarsTwoFourBedsBrokenLostRatio: Math.floor(player.stats.BedWars.twoFour.beds.ratio),
      bedwarsTwoFourPlayedGames: Math.floor(player.stats.BedWars.twoFour.gamesPlayed),
      ...
      skywarsKillDeathRatio: Math.floor(player.stats.SkyWars.kills.total.ratio),
      skywarsWins: Math.floor(player.stats.SkyWars.wins),
      skywarsLosses: Math.floor(player.stats.SkyWars.losses),
      skywarsWinLossRatio: Math.floor(player.stats.SkyWars.winLossRatio),
      ...
      duelsKillDeathRatio: Math.floor(player.stats.Duels.killDeathRatio),
      duelsWins: Math.floor(player.stats.Duels.wins),
      duelsLosses: Math.floor(player.stats.Duels.losses),
      duelsWinLossRatio: Math.floor(player.stats.Duels.winLossRatio),
