...
class LinkedManager extends GenericManager<LinkedUserData, LinkedData, LinkedUser> {
  ...
  async getPlayerVariableStats(
    ...
    return {
      ...
      bedwars4v4KillDeathRatio: Math.floor(player.stats.BedWars.twoFour.kills.total.ratio),
      ...
      bedwars4v4FinalKillDeathRatio: Math.floor(player.stats.BedWars.twoFour.finals.total.ratio),
