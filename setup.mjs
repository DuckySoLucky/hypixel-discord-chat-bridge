...
(async () => {
  ...
  const minecraftBot = await inquirer.prompt([
    {
      type: "input",
      name: "prefix",
      message: "Minecraft Guild Commands Prefix",
      default: "!",
    },
  ]);
  ...
  const minecraftCommands = await inquirer.prompt([
    {
      type: "confirm",
      name: "normal",
      message: "Minecraft Guild Normal Commands",
      default: true,
    },
    {
      type: "confirm",
      name: "soupy",
      message: "Minecraft Guild Soupy Commands",
      default: true,
    },
  ]);
  ...
  const minecraftFragBot = await inquirer.prompt([
    {
      type: "confirm",
      name: "enabled",
      message: "Minecraft Frag Bot Enabled",
      default: true,
    },
  ]);
  ...
  const requirementsInputs = await inquirer.prompt([
    {
      type: "confirm",
      name: "enabled",
      message: "Guild Requirements checker",
      default: false,
    },
    {
      type: "confirm",
  ...
  const requirements = await inquirer.prompt([
    {
      type: "number",
      name: "bedwarsStars",
      message: "Bedwars Stars Requirement",
      default: -1,
    },
    {
      type: "number",
      name: "bedwarsStarsWithFKDR",
      message: "Bedwars Stars With FKDR Requirement",
      default: -1,
    },
    {
      type: "number",
      name: "bedwarsFKDR",
      message: "Bedwars FKDR Requirement",
      default: -1,
    },
    {
      type: "number",
      name: "skywarsStars",
      message: "Skywars Stars Requirement",
      default: -1,
    },
    {
      type: "number",
      name: "skywarsStarsWithKDR",
      message: "Skywars Stars With KDR Requirement",
      default: -1,
    },
    {
      type: "number",
      name: "skywarsKDR",
      message: "Skywars KDR Requirement",
      default: -1,
    },
    {
      type: "number",
      name: "duelsWins",
      message: "Duels Wins Requirement",
      default: -1,
    },
    {
      type: "number",
      name: "duelsWinsWithWLR",
      message: "Duels Wins With WLR Requirement",
      default: -1,
    },
    {
      type: "number",
      name: "duelsWLR",
      message: "Duels WLR Requirement",
      default: -1,
    },
    {
      type: "number",
      name: "senitherWeight",
      message: "Senither Weight Requirement",
      default: -1,
    },
    {
      type: "number",
      name: "lilyWeight",
      message: "Lily Weight Requirement",
      default: -1,
    },
    {
      type: "number",
      name: "skyblockLevel",
      message: "Skyblock Level Requirement",
      default: -1,
    },
  ]);
  ...
  const skyblockNotifications = await inquirer.prompt([
    {
      type: "confirm",
      name: "BANK_INTEREST",
      message: "Bank Interest",
      default: true,
    },
    {
      type: "confirm",
      name: "DARK_AUCTION",
      message: "Dark Auction",
      default: true,
    },
    {
      type: "confirm",
      name: "ELECTION_BOOTH_OPENS",
      message: "Election Booth Opens",
      default: true,
    },
    {
      type: "confirm",
    ...
    {
      type: "confirm",
      name: "FALLEN_STAR_CULT",
      message: "Fallen Star Cult",
      default: true,
    },
    {
      type: "confirm",
      name: "FEAR_MONGERER",
      message: "Fear Mongerer",
      default: true,
    },
    {
      type: "confirm",
      name: "JACOBS_CONTEST",
      message: "Jacobs Contest",
      default: true,
    },
    {
      type: "confirm",
      name: "JERRYS_WORKSHOP",
      message: "Jerrys Workshop",
      default: true,
    },
    {
      type: "confirm",
      name: "NEW_YEAR_CELEBRATION",
      message: "New Year Celebration",
      default: true,
    },
    {
      type: "confirm",
      name: "SEASON_OF_JERRY",
      message: "Season Of Jerry",
      default: true,
    },
    {
      type: "confirm",
      name: "SPOOKY_FESTIVAL",
      message: "Spooky Festival",
      default: true,
    },
    {
      type: "confirm",
      name: "TRAVELING_ZOO",
      message: "Traveling Zoo",
      default: true,
    },
    {
      type: "confirm",
      name: "HOPPITY_HUNT",
      message: "Hoppity Hunt",
      default: true,
    },
  ]);
  ...
  const hypixelNotfications = await inquirer.prompt([
    ...
    {
      type: "confirm",
      name: "skyblockVersion",
      message: "Skyblock Version",
      default: true,
    },
  ]);
  ...
  const checks = await inquirer.prompt([
    {
      type: "confirm",
      name: "inServer",
      message: "Is the bot in the server",
    },
  ]);
  ...
  let channels = await inquirer.prompt([
    {
      type: "confirm",
      name: "channelSetup",
      message: "Do you already have the required channels created?",
    },
    {
      type: "confirm",
      name: "autoCreate",
  ...
  const discordOther = await inquirer.prompt([
    ...
    },
    {
      type: "confirm",
      name: "joinMessage",
      message: "Send a message when someone joins or leaves",
      default: true,
    },
    {
      type: "confirm",
  ...
  const other = await inquirer.prompt([
    {
      type: "confirm",
      name: "autoUpdater",
      message: "Should the bot check for updates",
      default: true,
    },
    {
      type: "number",
